...
const extraerSinEmpateBw = async (tiempoReglamentarioClass, selector) =>{
    try{
    ...
    return cuotas;
        ...
        console.error('error al extraer cuotas sin empate bw', err.message);
    }
}

module.exports= {extraerSinEmpateBw}