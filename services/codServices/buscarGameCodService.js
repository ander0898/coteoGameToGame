...
// var intento = 0;
const buscarGameCod = async (local, visitante, deporte, intento)=>{
    var page;
    ...
    try{
        ...
        // if(inputBuscar){
            ...
            await page.waitForSelector('.sb-grid-header--onlive.background-color-regular');
        ...
        return await buscarGameCod(local, visitante, deporte, intento);
    }
}
